...
@push('scripts')
    <!-- Datatable JS -->
    <script src="{{ URL::asset('') }}assets/plugins/datatables/datatables.min.js" type="4d9dfd1d77442bb5a1e5854e-text/javascript"></script>

    <!-- select CSS -->
    <script src="{{ URL::asset('') }}assets/plugins/select2/js/select2.min.js" type="4d9dfd1d77442bb5a1e5854e-text/javascript"></script>

    <!-- Slimscroll JS -->
    <script src="{{ URL::asset('') }}assets/plugins/slimscroll/jquery.slimscroll.min.js" type="4d9dfd1d77442bb5a1e5854e-text/javascript"></script>

    <!-- Datepicker Core JS -->
    <script src="{{ URL::asset('') }}assets/plugins/moment/moment.min.js" type="4d9dfd1d77442bb5a1e5854e-text/javascript"></script>
    <script src="{{ URL::asset('') }}assets/js/bootstrap-datetimepicker.min.js" type="4d9dfd1d77442bb5a1e5854e-text/javascript"></script>

    <!-- Apexchart JS -->
    <script src="{{ URL::asset('') }}assets/plugins/apexchart/apexcharts.min.js" type="4d9dfd1d77442bb5a1e5854e-text/javascript"></script>
    <script src="{{ URL::asset('') }}assets/plugins/apexchart/chart-data.js" type="4d9dfd1d77442bb5a1e5854e-text/javascript"></script>

    <!-- multiselect JS -->
    <script src="{{ URL::asset('') }}assets/js/jquery-ui.min.js" type="4d9dfd1d77442bb5a1e5854e-text/javascript"></script>
@endpush
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="text-end"><a href="invoice-subscription.html"
                                                        class="invoice-detail"><i class="fe fe-file-text"></i></a>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td><a href="invoice-details.html"
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-end">
                                                    <div class="active-inactive-btn">
                                                        <a href="dashboard.html#" class="active-domain"><i
                                                                class="fe fe-check"></i></a>
                                                        <a href="dashboard.html#" class="inactive-domain"><i
                                                                class="fe fe-x"></i></a>
                                                    </div>
                                                </td>
                                            </tr>

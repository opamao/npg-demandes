...
@push('scripts')
    <!-- Datatable JS -->
    <script src="{{ URL::asset('') }}assets/plugins/datatables/datatables.min.js" type="d35c5cca18479b09b93f4fc7-text/javascript"></script>

    <!-- select CSS -->
    <script src="{{ URL::asset('') }}assets/plugins/select2/js/select2.min.js" type="d35c5cca18479b09b93f4fc7-text/javascript"></script>

    <!-- Slimscroll JS -->
    <script src="{{ URL::asset('') }}assets/plugins/slimscroll/jquery.slimscroll.min.js" type="d35c5cca18479b09b93f4fc7-text/javascript"></script>

    <!-- Moment JS -->
    <script src="{{ URL::asset('') }}assets/plugins/moment/moment.min.js" type="d35c5cca18479b09b93f4fc7-text/javascript"></script>

    <!-- Datepicker Core JS -->
    <script src="{{ URL::asset('') }}assets/plugins/moment/moment.min.js" type="d35c5cca18479b09b93f4fc7-text/javascript"></script>
    <script src="{{ URL::asset('') }}assets/js/bootstrap-datetimepicker.min.js" type="d35c5cca18479b09b93f4fc7-text/javascript"></script>

    <!-- multiselect JS -->
    <script src="{{ URL::asset('') }}assets/js/jquery-ui.min.js" type="d35c5cca18479b09b93f4fc7-text/javascript"></script>
@endpush
                        ...
                        <ul class="filter-list">
                            ...
                            <li class="">
                                <div class="dropdown dropdown-action" data-bs-toggle="tooltip" data-bs-placement="top"
                                    ...
                                    <a href="inventory.html#" class="btn-filters" data-bs-toggle="dropdown"
                                                ...
                                                <div class="dropdown dropdown-action">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        <ul>
                                                            ...
                                                            <li>
                                                                <a class="dropdown-item" href="inventory.html#"
                                                                    data-bs-toggle="modal" data-bs-target="#delete_stock"><i
    ...
    <div class="toggle-sidebar">
        <div class="sidebar-layout-filter">
            <div class="sidebar-header">
                <h5>Filter</h5>
                <a href="inventory.html#" class="sidebar-closes"><i class="fa-regular fa-circle-xmark"></i></a>
            </div>
            <div class="sidebar-body">
                <form action="inventory.html#" autocomplete="off">
                    <!-- Product -->
            ...
            <div class="modal-content">
                <div class="modal-body">
                    ...
                    <div class="modal-btn delete-action">
                        <div class="row">
                            <div class="col-6">
                                <a href="inventory.html#" class="btn btn-primary paid-continue-btn">Delete</a>
                            </div>
                            <div class="col-6">
                                <a href="inventory.html#" data-bs-dismiss="modal"
                                        ...
                                        <ul class="filter-list">
                                            <li class="">
                                                <div class="dropdown dropdown-action" data-bs-toggle="tooltip"
                                                    ...
                                                    <a href="inventory.html#" class="btn-filters"
                                            ...
                                            <li>
                                                <a class="btn-filters" href="javascript:void(0);"
                                                    ...
                                                    data-bs-original-title="print"><span><i
                                                            class="fe fe-printer"></i></span> </a>
                                            </li>
                                        </ul>
                                    </div>

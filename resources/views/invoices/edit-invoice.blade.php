...
@push('scripts')
    ...
    <!-- Datatable JS -->
    <script src="{{ URL::asset('') }}assets/plugins/datatables/datatables.min.js" type="5a41edda6b976cf845682f26-text/javascript"></script>

    <!-- select CSS -->
    <script src="{{ URL::asset('') }}assets/plugins/select2/js/select2.min.js" type="5a41edda6b976cf845682f26-text/javascript"></script>

    <!-- Slimscroll JS -->
    <script src="{{ URL::asset('') }}assets/plugins/slimscroll/jquery.slimscroll.min.js" type="5a41edda6b976cf845682f26-text/javascript"></script>

    <!-- Datepicker Core JS -->
    <script src="{{ URL::asset('') }}assets/plugins/moment/moment.min.js" type="5a41edda6b976cf845682f26-text/javascript"></script>
    <script src="{{ URL::asset('') }}assets/js/bootstrap-datetimepicker.min.js" type="5a41edda6b976cf845682f26-text/javascript"></script>

    <!-- multiselect JS -->
    <script src="{{ URL::asset('') }}assets/js/jquery-ui.min.js" type="5a41edda6b976cf845682f26-text/javascript"></script>
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td class="d-flex align-items-center">
                                                                ...
                                                                <a href="edit-invoice.html#" class="btn-action-icon"
                                                                    data-bs-toggle="modal"
                                                ...
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-groups">
                                                            <a class="btn btn-primary" href="edit-invoice.html#"
                                                                data-bs-toggle="modal"
            ...
            <div class="modal-dialog modal-dialog-centered modal-md">
                <div class="modal-content">
                    ...
                    <div class="modal-footer add-tax-btns">
                        <a href="edit-invoice.html#" data-bs-dismiss="modal"
                            class="btn add-btn-cancel-btn">Cancel</a>
                        <a href="edit-invoice.html#" data-bs-dismiss="modal"
                            class="btn btn-primary add-tax-save-btn">Update</a>
                    </div>
                </div>
            </div>
        </div>

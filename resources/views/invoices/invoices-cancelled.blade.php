...
@push('scripts')
    ...
    <!-- Datatable JS -->
    <script src="assets/plugins/datatables/datatables.min.js" type="7c5ce2334606e0411596eaa1-text/javascript"></script>

    <!-- select CSS -->
    <script src="assets/plugins/select2/js/select2.min.js" type="7c5ce2334606e0411596eaa1-text/javascript"></script>

    <!-- Slimscroll JS -->
    <script src="assets/plugins/slimscroll/jquery.slimscroll.min.js" type="7c5ce2334606e0411596eaa1-text/javascript"></script>

    <!-- Datepicker Core JS -->
    <script src="assets/plugins/moment/moment.min.js" type="7c5ce2334606e0411596eaa1-text/javascript"></script>
    <script src="assets/js/bootstrap-datetimepicker.min.js" type="7c5ce2334606e0411596eaa1-text/javascript"></script>

    <!-- multiselect JS -->
    <script src="assets/js/jquery-ui.min.js" type="7c5ce2334606e0411596eaa1-text/javascript"></script>
@endpush
                            ...
                            <ul class="filter-list">
                                ...
                                <li>
                                    <a class="btn-filters" href="javascript:void(0);" data-bs-toggle="tooltip"
                                        data-bs-placement="bottom" title="Settings"><span><i
                                ...
                                <li>
                                    <a class="btn btn-primary" href="add-invoice.html"><i
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    <p class="inovices-all">No of Invoice <span
                                            class="rounded-circle bg-light-gray">02</span></p>
                    ...
                    <div class="col-xl-2 col-lg-4 col-sm-6 col-12">
                        <div class="card inovices-card">
                            <div class="card-body">
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    <p class="inovices-all">No of Invoice <span
                                            class="rounded-circle bg-light-gray">03</span></p>
                    ...
                    <div class="col-xl-2 col-lg-4 col-sm-6 col-12">
                        <div class="card inovices-card">
                            <div class="card-body">
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    <p class="inovices-all">No of Invoice <span
                                            class="rounded-circle bg-light-gray">01</span></p>
                    ...
                    <div class="col-xl-2 col-lg-4 col-sm-6 col-12">
                        <div class="card inovices-card">
                            <div class="card-body">
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    <p class="inovices-all">No of Invoice <span
                                            class="rounded-circle bg-light-gray">04</span></p>
                    ...
                    <div class="col-xl-2 col-lg-4 col-sm-6 col-12">
                        <div class="card inovices-card">
                            <div class="card-body">
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    <p class="inovices-all">No of Invoice <span
                                            class="rounded-circle bg-light-gray">06</span></p>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-end">
                                                    <div class="dropdown dropdown-action">
                                                        <a href="invoices-cancelled.html#" class="btn-action-icon"
                                                        ...
                                                        <div
                                                            ...
                                                            <a class="dropdown-item"
                                                                href="invoices-cancelled.html"><i
        ...
        <div class="toggle-sidebar">
            <div class="sidebar-layout-filter">
                <div class="sidebar-header">
                    <h5>Filter</h5>
                    <a href="invoices-cancelled.html#" class="sidebar-closes"><i
                            class="fa-regular fa-circle-xmark"></i></a>
                </div>
                <div class="sidebar-body">
                    <form action="invoices-cancelled.html#" autocomplete="off">
                        <!-- Customer -->

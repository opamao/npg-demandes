...
@push('scripts')
    <!-- Datatable JS -->
    <script src="assets/plugins/datatables/datatables.min.js" type="41122becdeb95aea5ae9fe23-text/javascript"></script>
    <!-- select CSS -->
    <script src="assets/plugins/select2/js/select2.min.js" type="41122becdeb95aea5ae9fe23-text/javascript"></script>
    <!-- Slimscroll JS -->
    <script src="assets/plugins/slimscroll/jquery.slimscroll.min.js" type="41122becdeb95aea5ae9fe23-text/javascript"></script>
    <!-- Datepicker Core JS -->
    <script src="assets/plugins/moment/moment.min.js" type="41122becdeb95aea5ae9fe23-text/javascript"></script>
    <script src="assets/js/bootstrap-datetimepicker.min.js" type="41122becdeb95aea5ae9fe23-text/javascript"></script>
    <!-- multiselect JS -->
    <script src="assets/js/jquery-ui.min.js" type="41122becdeb95aea5ae9fe23-text/javascript"></script>
@endpush
                        ...
                        <div class="col-lg-12">
                            <div class="invoices-tabs">
                                <ul>
                                    ...
                                    <li><a href="{{ url('invoices-recurring') }}" class="active">Partially Paid</a></li>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-end">
                                                <div class="dropdown dropdown-action">
                                                    <a href="invoices-recurring.html#" class="btn-action-icon"
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-end customer-dropdown">
                                                        ...
                                                        <a class="dropdown-item" href="invoices-recurring.html"><i
    ...
    <div class="toggle-sidebar">
        <div class="sidebar-layout-filter">
            <div class="sidebar-header">
                <h5>Filter</h5>
                <a href="invoices-recurring.html#" class="sidebar-closes"><i class="fa-regular fa-circle-xmark"></i></a>
            </div>
            <div class="sidebar-body">
                <form action="invoices-recurring.html#" autocomplete="off">
                    <!-- Customer -->

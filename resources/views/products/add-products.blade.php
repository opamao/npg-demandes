...
@push('scripts')
    <!-- Feather Icon JS -->
    <script src="{{ URL::asset('') }}assets/js/feather.min.js" type="214f8c3bb3882a802ba44c82-text/javascript"></script>

    <!-- Slimscroll JS -->
    <script src="{{ URL::asset('') }}assets/plugins/slimscroll/jquery.slimscroll.min.js" type="214f8c3bb3882a802ba44c82-text/javascript"></script>

    <!-- Select2 JS -->
    <script src="{{ URL::asset('') }}assets/plugins/select2/js/select2.min.js" type="214f8c3bb3882a802ba44c82-text/javascript"></script>

    <!-- Moment JS -->
    <script src="{{ URL::asset('') }}assets/plugins/moment/moment.min.js" type="214f8c3bb3882a802ba44c82-text/javascript"></script>

    <!-- Summernote JS -->
    <script src="{{ URL::asset('') }}assets/plugins/summernote/summernote-lite.min.js" type="214f8c3bb3882a802ba44c82-text/javascript"></script>
@endpush
@section('content')
    <!-- Page Wrapper -->

...
@push('scripts')
    <!-- Datatable JS -->
    <script src="assets/plugins/datatables/datatables.min.js" type="fae9e331c33b619d93d5611c-text/javascript"></script>
    <!-- select CSS -->
    <script src="assets/plugins/select2/js/select2.min.js" type="fae9e331c33b619d93d5611c-text/javascript"></script>
    <!-- Slimscroll JS -->
    <script src="assets/plugins/slimscroll/jquery.slimscroll.min.js" type="fae9e331c33b619d93d5611c-text/javascript"></script>
    <!-- Datepicker Core JS -->
    <script src="assets/plugins/moment/moment.min.js" type="fae9e331c33b619d93d5611c-text/javascript"></script>
    <script src="assets/js/bootstrap-datetimepicker.min.js" type="fae9e331c33b619d93d5611c-text/javascript"></script>
    <!-- multiselect JS -->
    <script src="assets/js/jquery-ui.min.js" type="fae9e331c33b619d93d5611c-text/javascript"></script>
@endpush
@section('content')
    <!-- Page Wrapper -->
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td class="d-flex align-items-center">
                                                                <a href="add-delivery-challans.html#"
                                                ...
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-groups">
                                                            <a class="btn btn-primary" href="add-delivery-challans.html#"
        ...
        <div class="modal-dialog modal-dialog-centered modal-md">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="reset" class="btn btn-primary paid-cancel-btn me-2">Back</button>
            ...
            <div class="modal-content">
                <div class="modal-body">
                    ...
                    <div class="modal-btn delete-action">
                        <div class="row">
                            <div class="col-6">
                                <a href="add-delivery-challans.html#" data-bs-dismiss="modal"
    ...
    <div class="modal custom-modal fade" id="bank_details" role="dialog">
        <div class="modal-dialog modal-dialog-centered modal-md">
            <div class="modal-content">
                ...
                <form action="add-delivery-challans.html#">
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-lg-12 col-md-12">
                                <div class="input-block mb-3">

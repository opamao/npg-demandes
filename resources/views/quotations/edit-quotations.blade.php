...
@push('scripts')
    <!-- Datatable JS -->
    <script src="assets/plugins/datatables/datatables.min.js" type="484accc07a24faf0aa70e9f7-text/javascript"></script>
    <!-- select CSS -->
    <script src="assets/plugins/select2/js/select2.min.js" type="484accc07a24faf0aa70e9f7-text/javascript"></script>
    <!-- Slimscroll JS -->
    <script src="assets/plugins/slimscroll/jquery.slimscroll.min.js" type="484accc07a24faf0aa70e9f7-text/javascript"></script>
    <!-- Datepicker Core JS -->
    <script src="assets/plugins/moment/moment.min.js" type="484accc07a24faf0aa70e9f7-text/javascript"></script>
    <script src="assets/js/bootstrap-datetimepicker.min.js" type="484accc07a24faf0aa70e9f7-text/javascript"></script>
    <!-- multiselect JS -->
    <script src="assets/js/jquery-ui.min.js" type="484accc07a24faf0aa70e9f7-text/javascript"></script>
@endpush
@section('content')
    <!-- Page Wrapper -->
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td class="d-flex align-items-center">
                                                                <a href="edit-quotations.html#" class="btn-action-icon me-2"
                                                                    data-bs-toggle="modal"
                                                                    data-bs-target="#add_discount"><span><i
                                                                            class="fe fe-edit"></i></span></a>
                                                                <a href="edit-quotations.html#" class="btn-action-icon"
                                                                    data-bs-toggle="modal"
                                                ...
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-groups">
                                                            <a class="btn btn-primary" href="edit-quotations.html#"
        ...
        <div class="modal-dialog modal-dialog-centered modal-md">
            <div class="modal-content">
                ...
                <div class="modal-footer add-tax-btns">
                    <a href="edit-quotations.html#" data-bs-dismiss="modal" class="btn add-btn-cancel-btn">Cancel</a>
                    <a href="edit-quotations.html#" data-bs-dismiss="modal"
